...
@section('title', 'Kullanım Alanı Galeri Listesi')
...
<!--begin::App Content Header-->
        <div class="app-content-header">
          ...
          <div class="container-fluid">
            <!--begin::Row-->
            <div class="row">
              <div class="col-sm-6"><h3 class="mb-0">Kullanım Alanı Galeri Listesi</h3></div>
              <div class="col-sm-6">
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex justify-content-between align-items-center">
                            <h5 class="card-title mb-0">Kullanım Alanı Galeri Listesi</h5>
                            <a href="{{ route('admin.using_areas.gallery.create', $id) }}" class="btn btn-primary">
                                ...
                                @foreach($gallery as $key => $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <form action="{{ route('admin.using_areas.gallery.destroy', [$id, $item->image_id]) }}" method="POST" style="display:inline;">
                                                @csrf
                                                @method('DELETE')
