                    ...
                    <div class="flex flex-col h-full w-full">
                        <div class="news-page-detail flex flex-col gap-[45px] md:gap-[30px] w-full h-full md:h-auto">
                            <div class="top w-full flex flex-col gap-[20px]">
                                ...
                                <h1 class="text-[48px] 2xl:text-[40px] xl:text-[30px] md:text-[20px] leading-[64px] xl:leading-[35px] text-secondary-main font-semibold reveal">Our Ifence brand generally produces and assembles fence systems, door systems and</h1>
                            </div>
                                            ...
                                            <div class="item w-full rounded-[10px] overflow-hidden bg-secondary-main">
                                                <div class="flex xsm:flex-col">
                                                    ...
                                                    <div class="content p-[80px] 2xl:p-[65px] xl:p-[45px] lg:p-[25px] flex flex-col justify-center gap-[20px]">
                                                        ...
                                                        <p class="text-[18px] lg:text-[16px] leading-[24px] text-white/75 mb-[60px] xl:mb-[35px] sm:mb-0"><?= $item['description'] ?></p>
                                                        <?php
